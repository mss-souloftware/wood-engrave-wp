(function ($) {
    ...
    // Initialize the canvas size once based on the container and image dimensions
    const img = new Image();
    img.onload = () => {
        const container = canvas.parentElement;

        // Set canvas size based on the container or image size
        canvas.width = container.offsetWidth;
        canvas.height = (img.height / img.width) * container.offsetWidth; // Maintain aspect ratio
